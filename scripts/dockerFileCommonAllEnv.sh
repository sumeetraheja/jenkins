...
echo "ADD /properties/${PROJECT_NAME}/application-${DEPLOY_ENVIRONMENT}.yml application-${DEPLOY_ENVIRONMENT}.yml" >> Dockerfile
echo "CMD java $JAVA_OPTS -jar app.war --spring.config.location=application-${DEPLOY_ENVIRONMENT}.yml" >> Dockerfile
